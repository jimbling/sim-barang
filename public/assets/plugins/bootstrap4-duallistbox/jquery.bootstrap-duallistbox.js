...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      filterPlaceHolder: 'Batas',
      moveSelectedLabel: 'Pindahkan terpilih',
      moveAllLabel: 'Pindah semua',
      ...
      infoText: 'Menampilkan semua {0}',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="badge badge-warning">Disaring</span> {0} from {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: 'Kosongkan daftar',                                                        // when there are no options present in the list
