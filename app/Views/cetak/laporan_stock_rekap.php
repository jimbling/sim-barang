...
<head>
    ...
    <title>Laporan Rekap Stok Opname_<?= $tahun ?>
    </title>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <h2>
            <center><b> REKAP STOCK OPNAME BARANG HABIS PAKAI LABORATORIUM KEPERAWATAN
                    <P>Tahun: <?= $tahun ?>
                </b></CENTER>
        </h2>
        ...
        <div class="table-container page-break-before">
            <table class="table table-border">
                ...
                <tbody class="table-border">
                    <?php if (empty($stockDataRekap)) : ?>
                        <tr>
                            <td colspan="5" style="text-align: center;">Tidak Ada Data Peminjaman Barang Laboratorium Keperawatan pada <strong>Tahun: <?= $tahun ?> </strong></td>
                        </tr>
                    <?php else : ?>
                        <?php $i = 1;
                        $totalStok = 0; ?>
                        <?php foreach ($stockDataRekap as $data) : ?>
                            <tr>
                                <th><?= $i++; ?></th>
