...
<head>
    ...
    <title>Laporan Penerimaan Tahun_<?= $tahun ?>
    </title>
            ...
            <table class="table table-border">
                ...
                <tbody>
                    ...
                    if (empty($data_peminjaman)) {
                        echo '<tr><td colspan="8">Tidak ada data Penerimaan Barang Persediaan Laboratorium Keperawatan<strong>  Tahun ' . $tahun . ' </strong> </td></tr>';
                    } else {
