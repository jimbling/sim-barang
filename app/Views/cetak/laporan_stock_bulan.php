...
<head>
    ...
    <title>Laporan Stok Opname Bulan_<?= $namaBulan ?>_<?= $tahun ?>
    </title>
            ...
            <table class="table table-border">
                ...
                <tbody class="table-border">
                    <?php if (empty($stockData)) : ?>
                        <tr>
                            <td colspan="5" style="text-align: center;">Tidak Ada Data Stock Opname Barang Habis Pakai Laboratorium Keperawatan pada <strong>Bulan: <?= $namaBulan ?> Tahun: <?= $tahun ?> </strong></td>
                        </tr>
                    <?php else : ?>
                        <?php $i = 1;
                        $totalStok = 0; ?>
