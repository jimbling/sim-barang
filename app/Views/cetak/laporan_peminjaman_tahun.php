...
<head>
    ...
    <title>Laporan Peminjaman Tahun_<?= $tahun ?>
    </title>
            ...
            <table class="table table-border">
                ...
                <tbody class="table-border ">
                    <?php if (empty($data_peminjaman)) : ?>
                        <tr>
                            <td colspan="8" style="text-align: center;">Tidak Ada Data Peminjaman Barang Laboratorium Keperawatan pada <strong> Tahun: <?= $tahun ?> </strong></td>
                        </tr>
                    <?php else : ?>
