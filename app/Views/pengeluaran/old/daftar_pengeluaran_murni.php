...
<script>
    ...
    function buildTable(data) {
        var tableHtml = '<table class="table table-sm table-bordered"><thead class="bg-secondary" style="text-align: center; vertical-align: middle; font-size: 14px;"><tr><th>No</th><th>Nama Barang</th><th>Jumlah Barang</th><th>Satuan</th><th>Harga Satuan</th><th>Jumlah Harga</th><th>Tanggal Permintaan</th><th>Pengguna</th></tr></thead><tbody>';
